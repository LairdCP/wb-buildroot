...
echo "SOM60SD_MFG POST BUILD script: starting..."
...
tar c --exclude=.empty -C board/laird/som60sd_mfg/rootfs-additions/ . | tar x -C $TARGETDIR/
...
echo "SOM60SD_MFG POST BUILD script: done."

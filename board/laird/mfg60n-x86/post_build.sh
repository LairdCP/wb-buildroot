export BR2_LRD_PRODUCT=mfg60n-x86
...
cp board/laird/mfg60n-x86/rootfs-additions/reg_tools.sh $TARGET_DIR
cp $TARGET_DIR/usr/lib/libedit.so.0.0.53 $TARGET_DIR/usr/lib/libedit.lrd.so.0.0.53

...
echo "summit_supplicant-arm POST IMAGE script: starting..."

# enable tracing and exit on errors
set -x -e

test -z "$BR2_LRD_PRODUCT" && export BR2_LRD_PRODUCT=summit_supplicant-arm
...
echo "summit_supplicant-arm POST IMAGE script: done."

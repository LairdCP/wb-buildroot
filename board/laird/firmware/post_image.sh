...
tar -cjf "$IMAGESDIR/laird-sterling60-firmware-sdio-uart.tar.bz2" \
...
ln -rsf $FW_DIR/regulatory_sterling60.db $FW_DIR/regulatory.db
tar -cjf "$IMAGESDIR/laird-sterling60-firmware-sdio-sdio.tar.bz2" \
	./lib/firmware/lrdmwl/88W8997_sdio.bin \
...
ln -rsf $FW_DIR/regulatory_sterling60.db $FW_DIR/regulatory.db
tar -cjf "$IMAGESDIR/laird-sterling60-firmware-pcie-uart.tar.bz2" \
...
ln -rsf $FW_DIR/regulatory_sterling60.db $FW_DIR/regulatory.db
tar -cjf "$IMAGESDIR/laird-sterling60-firmware-pcie-usb.tar.bz2" \
	./lib/firmware/lrdmwl/88W8997_pcie.bin \
...
ln -rsf $FW_DIR/regulatory_sterling60.db $FW_DIR/regulatory.db
tar -cjf "$IMAGESDIR/laird-sterling60-firmware-usb-uart.tar.bz2" \
...
tar -cjf "$IMAGESDIR/laird-summit60-firmware-sdio-uart.tar.bz2" \
	./lib/firmware/lrdmwl/88W8997_sdio.bin \
...
ln -rsf $FW_DIR/regulatory_summit60.db $FW_DIR/regulatory.db
tar -cjf "$IMAGESDIR/laird-summit60-firmware-sdio-sdio.tar.bz2" \
	./lib/firmware/lrdmwl/88W8997_sdio.bin \
...
ln -rsf $FW_DIR/regulatory_summit60.db $FW_DIR/regulatory.db
tar -cjf "$IMAGESDIR/laird-summit60-firmware-pcie-uart.tar.bz2" \
	./lib/firmware/lrdmwl/88W8997_pcie.bin \
...
ln -rsf $FW_DIR/regulatory_summit60.db $FW_DIR/regulatory.db
tar -cjf "$IMAGESDIR/laird-summit60-firmware-pcie-usb.tar.bz2" \
	./lib/firmware/lrdmwl/88W8997_pcie.bin \
...
ln -rsf $FW_DIR/regulatory_summit60.db $FW_DIR/regulatory.db
tar -cjf "$IMAGESDIR/laird-summit60-firmware-usb-uart.tar.bz2" \
	./lib/firmware/lrdmwl/88W8997_usb.bin \
...
ln -rsf $FW_DIR/regulatory_summit60.db $FW_DIR/regulatory.db
tar -cjf "$IMAGESDIR/laird-som60-radio-firmware.tar.bz2" \
	./lib/firmware/lrdmwl/88W8997_sdio.bin \

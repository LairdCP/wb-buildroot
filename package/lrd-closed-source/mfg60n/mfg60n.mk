...
define LAIRD_MFG60N_LRT_BUILD_CMD
	$(TARGET_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) $(MFG60N_MAKE_OPTS) -C $(@D)/lrt
endef
endif
...
define LAIRD_MFG60N_VENDOR_BUILD_LMU_CMD
	$(TARGET_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) $(MFG60N_MAKE_OPTS)  -C $(@D)/lmu
endef
endif
...
define LAIRD_MFG60N_VENDOR_BUILD_LRU_CMD
	$(TARGET_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) $(MFG60N_MAKE_OPTS) -C $(@D)/lru
endef
endif
...
define LAIRD_MFG60N_VENDOR_BUILD_BTLRU_CMD
	$(TARGET_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) $(MFG60N_MAKE_OPTS) -C $(@D)/btlru
endef
endif

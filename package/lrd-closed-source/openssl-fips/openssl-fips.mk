...
ifeq ($(ARCH),arm)
OPENSSL_FIPS_TARGET_ARCH = armv4
endif
ifeq ($(ARCH),powerpc)
# 4xx cores seem to have trouble with openssl's ASM optimizations
ifeq ($(BR2_powerpc_401)$(BR2_powerpc_403)$(BR2_powerpc_405)$(BR2_powerpc_405fp)$(BR2_powerpc_440)$(BR2_powerpc_440fp),)
OPENSSL_FIPS_TARGET_ARCH = ppc
endif
endif
ifeq ($(ARCH),powerpc64)
OPENSSL_FIPS_TARGET_ARCH = ppc64
endif
ifeq ($(ARCH),powerpc64le)
OPENSSL_FIPS_TARGET_ARCH = ppc64le
endif
ifeq ($(ARCH),x86_64)
OPENSSL_FIPS_TARGET_ARCH = x86_64
endif

# Workaround for bug #3445
ifeq ($(BR2_x86_i386),y)
OPENSSL_FIPS_TARGET_ARCH = generic32 386
endif
...
OPENSSL_FIPS_DEBUG = -d
endif

ifeq ($(BR2_PACKAGE_LAIRD_OPENSSL_FIPS),y)
# building from git repository
OPENSSL_FIPS_CONFIG_CMD_EXEC=./config $(OPENSSL_FIPS_DEBUG) fipscanisteronly
else

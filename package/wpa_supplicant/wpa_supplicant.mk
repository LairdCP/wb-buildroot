...
define WPA_SUPPLICANT_INSTALL_DBUS_NEW
	$(INSTALL) -m 0644 -D \
		...
		$(TARGET_DIR)/usr/share/dbus-1/system-services/sterling.$(WPA_SUPPLICANT_DBUS_NEW_SERVICE).service
        ln -s sterling.$(WPA_SUPPLICANT_DBUS_NEW_SERVICE).service \

MSD_BINARIES_VERSION = $(call qstrip,$(BR2_PACKAGE_LRD_RADIO_STACK_VERSION_VALUE))
MSD_BINARIES_COMPANY_PROJECT = $(call qstrip,$(BR2_PACKAGE_MSD_BINARIES_COMPANY_PROJECT))
...
ifeq ($(BR2_PACKAGE_MSD_BINARIES_SDCCLI),y)
MSD_BINARIES_DEPENDENCIES += libedit
endif
...
endef
ifeq ($(BR2_PACKAGE_MSD_BINARIES_WEBLCM),y)
...
endef
ifeq ($(BR2_PACKAGE_MSD_BINARIES_EVENTMON),y)
...
endef
ifeq ($(BR2_PACKAGE_MSD_BINARIES_SDCSUPP),y)
...
endef
ifeq ($(BR2_PACKAGE_MSD_BINARIES_LLAGENT),y)
...
endef
ifeq ($(BR2_PACKAGE_MSD_BINARIES_LAIRD_FIRMWARE_AR6003),y)
...
endef
ifeq ($(BR2_PACKAGE_MSD_BINARIES_LAIRD_FIRMWARE_AR6004),y)
...
endef
ifeq ($(BR2_PACKAGE_MSD_BINARIES_LAIRD_FIRMWARE_BT),y)

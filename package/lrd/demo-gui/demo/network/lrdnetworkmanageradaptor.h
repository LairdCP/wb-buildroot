#ifndef LRDNETWORKMANAGERADAPTOR_H
#define LRDNETWORKMANAGERADAPTOR_H
...
class LrdNetworkManagerAdaptor
{
public:
    LrdNetworkManagerAdaptor();
    ~LrdNetworkManagerAdaptor();
...
#endif // LRDNETWORKMANAGERADAPTOR_H

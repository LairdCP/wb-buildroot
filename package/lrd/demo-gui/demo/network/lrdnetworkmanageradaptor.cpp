...
#include "lrdnetworkmanageradaptor.h"


LrdNetworkManagerAdaptor::LrdNetworkManagerAdaptor()
{
...
void LrdNetworkManagerAdaptor::get_all_devices(QMap<int32_t, QStringList>& mDevName, QMap<QString, QString>& mDevPath)
{
...
void LrdNetworkManagerAdaptor::get_connection_settings_by_path(const QString& connPath, QMap<QString,
...
void  LrdNetworkManagerAdaptor::get_accesspoint_list_by_device_path(const QString devName, const QString& devPath,
...
QVariant LrdNetworkManagerAdaptor::basicTypeToVariant(const QDBusArgument &arg) 
{
    
    return arg.asVariant();
}

QVariantList LrdNetworkManagerAdaptor::arrayTypeToVariant(const QDBusArgument &arg) 
{
    QVariantList list;
    arg.beginArray();
...
QVariantMap LrdNetworkManagerAdaptor::mapTypeToVariant(const QDBusArgument &arg) 
{
    QString key;
    QVariant value;
    QVariantMap map;
...
//IPv4 Config
QVariant LrdNetworkManagerAdaptor::dbusArgumentToVariant(const QDBusArgument &arg) 
{
...
void LrdNetworkManagerAdaptor::get_ipv4_config(const QString& ipConnPath, QString& ipaddr, QString& mask, QString& gateway)
{
    QDBusInterface ifc (
        NM_DBUS_SERVICE,
        ipConnPath,
...
void LrdNetworkManagerAdaptor::get_connections_by_device(const QString& devName, const QString& devPath,
...
QString LrdNetworkManagerAdaptor::add_connection(const NMVariantMapMap& connsettings)
{
...
QString LrdNetworkManagerAdaptor::activate_connection(const QString& connPath)
{
 ...
 void LrdNetworkManagerAdaptor::update_connection(const QString& connPath, const NMVariantMapMap& connsettings)
 {
     QDBusInterface ifc (
         NM_DBUS_SERVICE,
         connPath,
...
void  LrdNetworkManagerAdaptor::disconnect_connection(const QString& connPath)
{
    QDBusObjectPath o1(connPath);
    nm->call("DeactivateConnection", QVariant::fromValue(o1));
}

void  LrdNetworkManagerAdaptor::delete_connection(const QString& connPath)
{
    QDBusInterface ifc (
        NM_DBUS_SERVICE,
        connPath,

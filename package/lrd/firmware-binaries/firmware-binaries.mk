...
define install-firmware-func
	unzip -p $(@D)/$(1)-$(FIRMWARE_BINARIES_VERSION).zip | tar -xjf - -C $(TARGET_DIR) --overwrite
endef
...
define FIRMWARE_BINARIES_930_0081_INSTALL_TARGET
	unzip -uo $(@D)/$(WL-FMAC)-$(FIRMWARE_BINARIES_VERSION).zip -d $(TARGET_DIR)/usr/bin/
endef
...
define FIRMWARE_BINARIES_STERLING_60_INSTALL_TARGET
	tar -xjf $(@D)/$(LRD-MWL)-$(FIRMWARE_BINARIES_VERSION).tar.bz2 -C $(TARGET_DIR) --overwrite
endef

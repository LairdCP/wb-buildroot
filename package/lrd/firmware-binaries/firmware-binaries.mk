FIRMWARE_BINARIES_VERSION = 6.0.2.13
...
define FIRMWARE_BINARIES_ATH6K_6003_INSTALL_TARGET
	tar -xjf $(DL_DIR)/$(ATH6K-6003)-$(FIRMWARE_BINARIES_VERSION).tar.bz2 -C $(TARGET_DIR) --overwrite
endef
...
define FIRMWARE_BINARIES_ATH6K_6004_INSTALL_TARGET
	tar -xjf $(DL_DIR)/$(ATH6K-6004)-$(FIRMWARE_BINARIES_VERSION).tar.bz2 -C $(TARGET_DIR) --overwrite
endef

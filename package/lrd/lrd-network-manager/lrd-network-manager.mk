...
define LRD_NETWORK_MANAGER_UPDATE_SERVICE
	sed -i -e '/^ExecStart=/ s#.*#ExecStart=/usr/sbin/NetworkManager --no-daemon --state-file=/etc/NetworkManager/NetworkManager.state#g' $(TARGET_DIR)/usr/lib/systemd/system/NetworkManager.service
endef

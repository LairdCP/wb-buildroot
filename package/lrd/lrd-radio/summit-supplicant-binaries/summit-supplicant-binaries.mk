...
SUMMIT_SUPPLICANT_BINARIES_SUFFIX = $(call qstrip,$(BR2_PACKAGE_SUMMIT_SUPPLICANT_BINARIES_OPENSSL)$(BR2_PACKAGE_LRD_RADIO_STACK_ARCH))
...
SUMMIT_SUPPLICANT_BINARIES_EXTRA_DOWNLOADS = summit_supplicant_legacy$(SUMMIT_SUPPLICANT_BINARIES_SUFFIX)-$(SUMMIT_SUPPLICANT_BINARIES_VERSION).tar.bz2

$(info $(SUMMIT_SUPPLICANT_BINARIES_EXTRA_DOWNLOADS))

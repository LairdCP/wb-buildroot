...
define OPENSSL_BUILD_CMDS
	$(MAKE) $(OPENSSL_FIPS_MAKE_OPT) -C $(@D)
endef

define OPENSSL_INSTALL_STAGING_CMDS
	$(MAKE) $(OPENSSL_FIPS_MAKE_OPT) -C $(@D) INSTALL_PREFIX=$(STAGING_DIR) install
endef

define HOST_OPENSSL_INSTALL_CMDS
	$(MAKE) $(OPENSSL_FIPS_MAKE_OPT) -C $(@D) install
endef

define OPENSSL_INSTALL_TARGET_CMDS
	$(MAKE) $(OPENSSL_FIPS_MAKE_OPT) -C $(@D) INSTALL_PREFIX=$(TARGET_DIR) install

...
LIBOPENSSL_1_0_2_VERSION = 1.0.2s
...
define LIBOPENSSL_1_0_2_INSTALL_STAGING_CMDS
	$(TARGET_MAKE_ENV) $(MAKE) $(LIBOPENSSL_1_0_2_FIPS_MAKE_OPT) -C $(@D) INSTALL_PREFIX=$(STAGING_DIR) install
endef
...
define LIBOPENSSL_1_0_2_INSTALL_TARGET_CMDS
	$(TARGET_MAKE_ENV) $(MAKE) $(LIBOPENSSL_1_0_2_FIPS_MAKE_OPT) -C $(@D) INSTALL_PREFIX=$(TARGET_DIR) install
